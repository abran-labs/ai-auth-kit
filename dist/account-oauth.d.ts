...
export declare function loginAccountOAuthProvider(kit: AuthKit, provider: ProviderDefinition, prompts: AccountOAuthLoginPrompts, deps?: AccountOAuthDeps): Promise<StoredCredential | undefined>;
