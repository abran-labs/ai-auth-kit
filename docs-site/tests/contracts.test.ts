...
import { type BuildLocation, validateDist, validateSource } from "../scripts/contracts"
  ...
  test("accepts a complete non-root distribution", async () => {
    ...
    try {
      ...
      await Promise.all([
        ...
        writeFile(resolve(distRoot, "guides/cli/index.html"), "cli"),
        ...
        writeFile(resolve(distRoot, "reference/cli/index.html"), "cli reference"),
        writeFile(resolve(distRoot, "reference/security/index.html"), "security"),
        writeFile(resolve(distRoot, "reference/linux-installer/index.html"), "installer"),
